...
تنها تغییر جدید داخل "show_category()" اضافه شده: دکمه 🗑️ خالی کردن سبد پایین لیست دسته/آیتم‌ها قرار می‌گیرد و همان callback قبلی "shop_clear_cart" را اجرا می‌کند. بقیه فایل دست‌نخورده است.
